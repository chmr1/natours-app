...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2htcjEiLCJhIjoiY2tqYmFlZHhrMjc1OTMzbnl0Z2VwOXF5aSJ9.q5fkK1JG8SBRcde6WgR_Ww';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend marker bounds to includes current locations
...
var stripe = Stripe('pk_test_51I5bDJGoLbaErS5OiP2NuyDCcf2GKJn8grvPbczt6dE0CTtT6tUrguh3Hf99x0ICFJ5ITodfcJkWIyai63ekONiR00zcBM6dkN'); // DOM ELEMENTS
